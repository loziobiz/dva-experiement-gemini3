...
class ApiClient {
  ...
  async uploadFile(file, config2) {
    ...
    const mimeType = (_a = config2 === null || config2 === void 0 ? void 0 : config2.mimeType) !== null && _a !== void 0 ? _a : fileStat.type;
    ...
    const uploadUrl = await this.fetchUploadUrl(path, fileToUpload.sizeBytes, fileToUpload.mimeType, fileName, body, config2 === null || config2 === void 0 ? void 0 : config2.httpOptions);
  ...
  async uploadFileToFileSearchStore(fileSearchStoreName, file, config2) {
    ...
    const uploadUrl = await this.fetchUploadUrl(path, sizeBytes, mimeType, fileName, body, config2 === null || config2 === void 0 ? void 0 : config2.httpOptions);
...
function shouldDisableAfc(config2) {
  var _a, _b, _c;
  if ((_a = config2 === null || config2 === void 0 ? void 0 : config2.automaticFunctionCalling) === null || _a === void 0 ? void 0 : _a.disable) {
    return true;
  }
...
function shouldAppendAfcHistory(config2) {
  var _a;
  return !((_a = config2 === null || config2 === void 0 ? void 0 : config2.automaticFunctionCalling) === null || _a === void 0 ? void 0 : _a.ignoreCallHistory);
}
/**
 * @license
 * Copyright 2025 Google LLC
  ...
  async fetch(request, env2) {
    ...
    if (url.pathname === "/api/analyze" && request.method === "POST") {
      try {
        ...
        const ai = new GoogleGenAI({ apiKey: env2.GEMINI_API_KEY });
        const prompt = `
